				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('') }}">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('') }}">الفواتير الغير مدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('') }}">الفواتير المدفوعه جزئيا</a></li>
						</ul>
					</li>
